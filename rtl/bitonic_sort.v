...
module bitonic_sort (
    ...
    // =========================================================
    wire [63:0] s1_d0,  s1_d1,  s1_d2,  s1_d3,  s1_d4,  s1_d5,  s1_d6,  s1_d7;
    wire [63:0] s1_d8,  s1_d9,  s1_d10, s1_d11, s1_d12, s1_d13, s1_d14, s1_d15;
    wire [ 3:0] s1_i0,  s1_i1,  s1_i2,  s1_i3,  s1_i4,  s1_i5,  s1_i6,  s1_i7;
    wire [ 3:0] s1_i8,  s1_i9,  s1_i10, s1_i11, s1_i12, s1_i13, s1_i14, s1_i15;

    compare_swap u_cs_s1_0_1   (.din_a(i_sq0),  .idx_a(i_idx0),  .din_b(i_sq1),  .idx_b(i_idx1),  .dir(1'b0), .dout_lo(s1_d0),  .idx_lo(s1_i0),  .dout_hi(s1_d1),  .idx_hi(s1_i1));
    compare_swap u_cs_s1_2_3   (.din_a(i_sq2),  .idx_a(i_idx2),  .din_b(i_sq3),  .idx_b(i_idx3),  .dir(1'b1), .dout_lo(s1_d2),  .idx_lo(s1_i2),  .dout_hi(s1_d3),  .idx_hi(s1_i3));
    compare_swap u_cs_s1_4_5   (.din_a(i_sq4),  .idx_a(i_idx4),  .din_b(i_sq5),  .idx_b(i_idx5),  .dir(1'b0), .dout_lo(s1_d4),  .idx_lo(s1_i4),  .dout_hi(s1_d5),  .idx_hi(s1_i5));
    compare_swap u_cs_s1_6_7   (.din_a(i_sq6),  .idx_a(i_idx6),  .din_b(i_sq7),  .idx_b(i_idx7),  .dir(1'b1), .dout_lo(s1_d6),  .idx_lo(s1_i6),  .dout_hi(s1_d7),  .idx_hi(s1_i7));
    compare_swap u_cs_s1_8_9   (.din_a(i_sq8),  .idx_a(i_idx8),  .din_b(i_sq9),  .idx_b(i_idx9),  .dir(1'b0), .dout_lo(s1_d8),  .idx_lo(s1_i8),  .dout_hi(s1_d9),  .idx_hi(s1_i9));
    compare_swap u_cs_s1_10_11 (.din_a(i_sq10), .idx_a(i_idx10), .din_b(i_sq11), .idx_b(i_idx11), .dir(1'b1), .dout_lo(s1_d10), .idx_lo(s1_i10), .dout_hi(s1_d11), .idx_hi(s1_i11));
    compare_swap u_cs_s1_12_13 (.din_a(i_sq12), .idx_a(i_idx12), .din_b(i_sq13), .idx_b(i_idx13), .dir(1'b0), .dout_lo(s1_d12), .idx_lo(s1_i12), .dout_hi(s1_d13), .idx_hi(s1_i13));
    compare_swap u_cs_s1_14_15 (.din_a(i_sq14), .idx_a(i_idx14), .din_b(i_sq15), .idx_b(i_idx15), .dir(1'b1), .dout_lo(s1_d14), .idx_lo(s1_i14), .dout_hi(s1_d15), .idx_hi(s1_i15));

    // =========================================================
    // Step 2: 跨2路比较，形成4个升/降序4元组
    // =========================================================
    wire [63:0] s2_d0,  s2_d1,  s2_d2,  s2_d3,  s2_d4,  s2_d5,  s2_d6,  s2_d7;
    wire [63:0] s2_d8,  s2_d9,  s2_d10, s2_d11, s2_d12, s2_d13, s2_d14, s2_d15;
    ...
    // =========================================================
    // Pipeline Register P1  (after step1+step2)
    // =========================================================
    reg         p1_vld;
    reg [15:0]  p1_bitmap;
    reg [63:0]  p1_d0,  p1_d1,  p1_d2,  p1_d3,  p1_d4,  p1_d5,  p1_d6,  p1_d7;
    reg [63:0]  p1_d8,  p1_d9,  p1_d10, p1_d11, p1_d12, p1_d13, p1_d14, p1_d15;
    ...
    always @(posedge clk) begin
        if (i_vld) begin
            p1_bitmap <= i_bitmap;
            p1_d0  <= s2_d0;  p1_i0  <= s2_i0;
            p1_d1  <= s2_d1;  p1_i1  <= s2_i1;
            p1_d2  <= s2_d2;  p1_i2  <= s2_i2;
            p1_d3  <= s2_d3;  p1_i3  <= s2_i3;
            p1_d4  <= s2_d4;  p1_i4  <= s2_i4;
            p1_d5  <= s2_d5;  p1_i5  <= s2_i5;
            p1_d6  <= s2_d6;  p1_i6  <= s2_i6;
            p1_d7  <= s2_d7;  p1_i7  <= s2_i7;
            p1_d8  <= s2_d8;  p1_i8  <= s2_i8;
            p1_d9  <= s2_d9;  p1_i9  <= s2_i9;
            p1_d10 <= s2_d10; p1_i10 <= s2_i10;
            p1_d11 <= s2_d11; p1_i11 <= s2_i11;
            p1_d12 <= s2_d12; p1_i12 <= s2_i12;
            p1_d13 <= s2_d13; p1_i13 <= s2_i13;
            p1_d14 <= s2_d14; p1_i14 <= s2_i14;
            p1_d15 <= s2_d15; p1_i15 <= s2_i15;
        end
    end
    ...
    // =========================================================
    wire [63:0] s3_d0,  s3_d1,  s3_d2,  s3_d3,  s3_d4,  s3_d5,  s3_d6,  s3_d7;
    wire [63:0] s3_d8,  s3_d9,  s3_d10, s3_d11, s3_d12, s3_d13, s3_d14, s3_d15;
    wire [ 3:0] s3_i0,  s3_i1,  s3_i2,  s3_i3,  s3_i4,  s3_i5,  s3_i6,  s3_i7;
    wire [ 3:0] s3_i8,  s3_i9,  s3_i10, s3_i11, s3_i12, s3_i13, s3_i14, s3_i15;

    compare_swap u_cs_s3_0_1   (.din_a(p1_d0),  .idx_a(p1_i0),  .din_b(p1_d1),  .idx_b(p1_i1),  .dir(1'b0), .dout_lo(s3_d0),  .idx_lo(s3_i0),  .dout_hi(s3_d1),  .idx_hi(s3_i1));
    compare_swap u_cs_s3_2_3   (.din_a(p1_d2),  .idx_a(p1_i2),  .din_b(p1_d3),  .idx_b(p1_i3),  .dir(1'b0), .dout_lo(s3_d2),  .idx_lo(s3_i2),  .dout_hi(s3_d3),  .idx_hi(s3_i3));
    compare_swap u_cs_s3_4_5   (.din_a(p1_d4),  .idx_a(p1_i4),  .din_b(p1_d5),  .idx_b(p1_i5),  .dir(1'b1), .dout_lo(s3_d4),  .idx_lo(s3_i4),  .dout_hi(s3_d5),  .idx_hi(s3_i5));
    compare_swap u_cs_s3_6_7   (.din_a(p1_d6),  .idx_a(p1_i6),  .din_b(p1_d7),  .idx_b(p1_i7),  .dir(1'b1), .dout_lo(s3_d6),  .idx_lo(s3_i6),  .dout_hi(s3_d7),  .idx_hi(s3_i7));
    compare_swap u_cs_s3_8_9   (.din_a(p1_d8),  .idx_a(p1_i8),  .din_b(p1_d9),  .idx_b(p1_i9),  .dir(1'b0), .dout_lo(s3_d8),  .idx_lo(s3_i8),  .dout_hi(s3_d9),  .idx_hi(s3_i9));
    compare_swap u_cs_s3_10_11 (.din_a(p1_d10), .idx_a(p1_i10), .din_b(p1_d11), .idx_b(p1_i11), .dir(1'b0), .dout_lo(s3_d10), .idx_lo(s3_i10), .dout_hi(s3_d11), .idx_hi(s3_i11));
    compare_swap u_cs_s3_12_13 (.din_a(p1_d12), .idx_a(p1_i12), .din_b(p1_d13), .idx_b(p1_i13), .dir(1'b1), .dout_lo(s3_d12), .idx_lo(s3_i12), .dout_hi(s3_d13), .idx_hi(s3_i13));
    compare_swap u_cs_s3_14_15 (.din_a(p1_d14), .idx_a(p1_i14), .din_b(p1_d15), .idx_b(p1_i15), .dir(1'b1), .dout_lo(s3_d14), .idx_lo(s3_i14), .dout_hi(s3_d15), .idx_hi(s3_i15));

    // =========================================================
    // Step 4: 跨4路比较，形成2个升/降序8元组
    // =========================================================
    wire [63:0] s4_d0,  s4_d1,  s4_d2,  s4_d3,  s4_d4,  s4_d5,  s4_d6,  s4_d7;
    wire [63:0] s4_d8,  s4_d9,  s4_d10, s4_d11, s4_d12, s4_d13, s4_d14, s4_d15;
    wire [ 3:0] s4_i0,  s4_i1,  s4_i2,  s4_i3,  s4_i4,  s4_i5,  s4_i6,  s4_i7;
    wire [ 3:0] s4_i8,  s4_i9,  s4_i10, s4_i11, s4_i12, s4_i13, s4_i14, s4_i15;

    compare_swap u_cs_s4_0_4   (.din_a(s3_d0),  .idx_a(s3_i0),  .din_b(s3_d4),  .idx_b(s3_i4),  .dir(1'b0), .dout_lo(s4_d0),  .idx_lo(s4_i0),  .dout_hi(s4_d4),  .idx_hi(s4_i4));
    compare_swap u_cs_s4_1_5   (.din_a(s3_d1),  .idx_a(s3_i1),  .din_b(s3_d5),  .idx_b(s3_i5),  .dir(1'b0), .dout_lo(s4_d1),  .idx_lo(s4_i1),  .dout_hi(s4_d5),  .idx_hi(s4_i5));
    compare_swap u_cs_s4_2_6   (.din_a(s3_d2),  .idx_a(s3_i2),  .din_b(s3_d6),  .idx_b(s3_i6),  .dir(1'b0), .dout_lo(s4_d2),  .idx_lo(s4_i2),  .dout_hi(s4_d6),  .idx_hi(s4_i6));
    compare_swap u_cs_s4_3_7   (.din_a(s3_d3),  .idx_a(s3_i3),  .din_b(s3_d7),  .idx_b(s3_i7),  .dir(1'b0), .dout_lo(s4_d3),  .idx_lo(s4_i3),  .dout_hi(s4_d7),  .idx_hi(s4_i7));
    compare_swap u_cs_s4_8_12  (.din_a(s3_d8),  .idx_a(s3_i8),  .din_b(s3_d12), .idx_b(s3_i12), .dir(1'b1), .dout_lo(s4_d8),  .idx_lo(s4_i8),  .dout_hi(s4_d12), .idx_hi(s4_i12));
    compare_swap u_cs_s4_9_13  (.din_a(s3_d9),  .idx_a(s3_i9),  .din_b(s3_d13), .idx_b(s3_i13), .dir(1'b1), .dout_lo(s4_d9),  .idx_lo(s4_i9),  .dout_hi(s4_d13), .idx_hi(s4_i13));
    compare_swap u_cs_s4_10_14 (.din_a(s3_d10), .idx_a(s3_i10), .din_b(s3_d14), .idx_b(s3_i14), .dir(1'b1), .dout_lo(s4_d10), .idx_lo(s4_i10), .dout_hi(s4_d14), .idx_hi(s4_i14));
    compare_swap u_cs_s4_11_15 (.din_a(s3_d11), .idx_a(s3_i11), .din_b(s3_d15), .idx_b(s3_i15), .dir(1'b1), .dout_lo(s4_d11), .idx_lo(s4_i11), .dout_hi(s4_d15), .idx_hi(s4_i15));

    // =========================================================
    // Pipeline Register P2  (after step3+step4)
    // =========================================================
    reg         p2_vld;
    reg [15:0]  p2_bitmap;
    reg [63:0]  p2_d0,  p2_d1,  p2_d2,  p2_d3,  p2_d4,  p2_d5,  p2_d6,  p2_d7;
    reg [63:0]  p2_d8,  p2_d9,  p2_d10, p2_d11, p2_d12, p2_d13, p2_d14, p2_d15;
    ...
    always @(posedge clk) begin
        if (p1_vld) begin
            p2_bitmap <= p1_bitmap;
            p2_d0  <= s4_d0;  p2_i0  <= s4_i0;
            p2_d1  <= s4_d1;  p2_i1  <= s4_i1;
            p2_d2  <= s4_d2;  p2_i2  <= s4_i2;
            p2_d3  <= s4_d3;  p2_i3  <= s4_i3;
            p2_d4  <= s4_d4;  p2_i4  <= s4_i4;
            p2_d5  <= s4_d5;  p2_i5  <= s4_i5;
            p2_d6  <= s4_d6;  p2_i6  <= s4_i6;
            p2_d7  <= s4_d7;  p2_i7  <= s4_i7;
            p2_d8  <= s4_d8;  p2_i8  <= s4_i8;
            p2_d9  <= s4_d9;  p2_i9  <= s4_i9;
            p2_d10 <= s4_d10; p2_i10 <= s4_i10;
            p2_d11 <= s4_d11; p2_i11 <= s4_i11;
            p2_d12 <= s4_d12; p2_i12 <= s4_i12;
            p2_d13 <= s4_d13; p2_i13 <= s4_i13;
            p2_d14 <= s4_d14; p2_i14 <= s4_i14;
            p2_d15 <= s4_d15; p2_i15 <= s4_i15;
        end
    end
    ...
    // =========================================================
    wire [63:0] s5_d0,  s5_d1,  s5_d2,  s5_d3,  s5_d4,  s5_d5,  s5_d6,  s5_d7;
    wire [63:0] s5_d8,  s5_d9,  s5_d10, s5_d11, s5_d12, s5_d13, s5_d14, s5_d15;
    wire [ 3:0] s5_i0,  s5_i1,  s5_i2,  s5_i3,  s5_i4,  s5_i5,  s5_i6,  s5_i7;
    wire [ 3:0] s5_i8,  s5_i9,  s5_i10, s5_i11, s5_i12, s5_i13, s5_i14, s5_i15;

    compare_swap u_cs_s5_0_2   (.din_a(p2_d0),  .idx_a(p2_i0),  .din_b(p2_d2),  .idx_b(p2_i2),  .dir(1'b0), .dout_lo(s5_d0),  .idx_lo(s5_i0),  .dout_hi(s5_d2),  .idx_hi(s5_i2));
    compare_swap u_cs_s5_1_3   (.din_a(p2_d1),  .idx_a(p2_i1),  .din_b(p2_d3),  .idx_b(p2_i3),  .dir(1'b0), .dout_lo(s5_d1),  .idx_lo(s5_i1),  .dout_hi(s5_d3),  .idx_hi(s5_i3));
    compare_swap u_cs_s5_4_6   (.din_a(p2_d4),  .idx_a(p2_i4),  .din_b(p2_d6),  .idx_b(p2_i6),  .dir(1'b0), .dout_lo(s5_d4),  .idx_lo(s5_i4),  .dout_hi(s5_d6),  .idx_hi(s5_i6));
    compare_swap u_cs_s5_5_7   (.din_a(p2_d5),  .idx_a(p2_i5),  .din_b(p2_d7),  .idx_b(p2_i7),  .dir(1'b0), .dout_lo(s5_d5),  .idx_lo(s5_i5),  .dout_hi(s5_d7),  .idx_hi(s5_i7));
    compare_swap u_cs_s5_8_10  (.din_a(p2_d8),  .idx_a(p2_i8),  .din_b(p2_d10), .idx_b(p2_i10), .dir(1'b1), .dout_lo(s5_d8),  .idx_lo(s5_i8),  .dout_hi(s5_d10), .idx_hi(s5_i10));
    compare_swap u_cs_s5_9_11  (.din_a(p2_d9),  .idx_a(p2_i9),  .din_b(p2_d11), .idx_b(p2_i11), .dir(1'b1), .dout_lo(s5_d9),  .idx_lo(s5_i9),  .dout_hi(s5_d11), .idx_hi(s5_i11));
    compare_swap u_cs_s5_12_14 (.din_a(p2_d12), .idx_a(p2_i12), .din_b(p2_d14), .idx_b(p2_i14), .dir(1'b1), .dout_lo(s5_d12), .idx_lo(s5_i12), .dout_hi(s5_d14), .idx_hi(s5_i14));
    ...
    reg         p3_vld;
    reg [15:0]  p3_bitmap;
    reg [63:0]  p3_d0,  p3_d1,  p3_d2,  p3_d3,  p3_d4,  p3_d5,  p3_d6,  p3_d7;
    reg [63:0]  p3_d8,  p3_d9,  p3_d10, p3_d11, p3_d12, p3_d13, p3_d14, p3_d15;
    reg [ 3:0]  p3_i0,  p3_i1,  p3_i2,  p3_i3,  p3_i4,  p3_i5,  p3_i6,  p3_i7;
    reg [ 3:0]  p3_i8,  p3_i9,  p3_i10, p3_i11, p3_i12, p3_i13, p3_i14, p3_i15;

    always @(posedge clk or negedge rst_n) begin
        if (!rst_n) p3_vld <= 1'b0;
        else        p3_vld <= p2_vld;
    end
    ...
    always @(posedge clk) begin
        if (p2_vld) begin
            p3_bitmap <= p2_bitmap;
            p3_d0  <= s6_d0;  p3_i0  <= s6_i0;
            p3_d1  <= s6_d1;  p3_i1  <= s6_i1;
            p3_d2  <= s6_d2;  p3_i2  <= s6_i2;
            p3_d3  <= s6_d3;  p3_i3  <= s6_i3;
            p3_d4  <= s6_d4;  p3_i4  <= s6_i4;
            p3_d5  <= s6_d5;  p3_i5  <= s6_i5;
            p3_d6  <= s6_d6;  p3_i6  <= s6_i6;
            p3_d7  <= s6_d7;  p3_i7  <= s6_i7;
            p3_d8  <= s6_d8;  p3_i8  <= s6_i8;
            p3_d9  <= s6_d9;  p3_i9  <= s6_i9;
            p3_d10 <= s6_d10; p3_i10 <= s6_i10;
            p3_d11 <= s6_d11; p3_i11 <= s6_i11;
            p3_d12 <= s6_d12; p3_i12 <= s6_i12;
            p3_d13 <= s6_d13; p3_i13 <= s6_i13;
            p3_d14 <= s6_d14; p3_i14 <= s6_i14;
            p3_d15 <= s6_d15; p3_i15 <= s6_i15;
        end
    end
    ...
    reg         p4_vld;
    reg [15:0]  p4_bitmap;
    reg [63:0]  p4_d0,  p4_d1,  p4_d2,  p4_d3,  p4_d4,  p4_d5,  p4_d6,  p4_d7;
    reg [63:0]  p4_d8,  p4_d9,  p4_d10, p4_d11, p4_d12, p4_d13, p4_d14, p4_d15;
    reg [ 3:0]  p4_i0,  p4_i1,  p4_i2,  p4_i3,  p4_i4,  p4_i5,  p4_i6,  p4_i7;
    reg [ 3:0]  p4_i8,  p4_i9,  p4_i10, p4_i11, p4_i12, p4_i13, p4_i14, p4_i15;

    always @(posedge clk or negedge rst_n) begin
        if (!rst_n) p4_vld <= 1'b0;
        else        p4_vld <= p3_vld;
    end
    ...
    always @(posedge clk) begin
        if (p3_vld) begin
            p4_bitmap <= p3_bitmap;
            p4_d0  <= s8_d0;  p4_i0  <= s8_i0;
            p4_d1  <= s8_d1;  p4_i1  <= s8_i1;
            p4_d2  <= s8_d2;  p4_i2  <= s8_i2;
            p4_d3  <= s8_d3;  p4_i3  <= s8_i3;
            p4_d4  <= s8_d4;  p4_i4  <= s8_i4;
            p4_d5  <= s8_d5;  p4_i5  <= s8_i5;
            p4_d6  <= s8_d6;  p4_i6  <= s8_i6;
            p4_d7  <= s8_d7;  p4_i7  <= s8_i7;
            p4_d8  <= s8_d8;  p4_i8  <= s8_i8;
            p4_d9  <= s8_d9;  p4_i9  <= s8_i9;
            p4_d10 <= s8_d10; p4_i10 <= s8_i10;
            p4_d11 <= s8_d11; p4_i11 <= s8_i11;
            p4_d12 <= s8_d12; p4_i12 <= s8_i12;
            p4_d13 <= s8_d13; p4_i13 <= s8_i13;
            p4_d14 <= s8_d14; p4_i14 <= s8_i14;
            p4_d15 <= s8_d15; p4_i15 <= s8_i15;
        end
    end
    ...
    compare_swap u_cs_s9_0_2   (.din_a(p4_d0),  .idx_a(p4_i0),  .din_b(p4_d2),  .idx_b(p4_i2),  .dir(1'b0), .dout_lo(s9_d0),  .idx_lo(s9_i0),  .dout_hi(s9_d2),  .idx_hi(s9_i2));
    compare_swap u_cs_s9_1_3   (.din_a(p4_d1),  .idx_a(p4_i1),  .din_b(p4_d3),  .idx_b(p4_i3),  .dir(1'b0), .dout_lo(s9_d1),  .idx_lo(s9_i1),  .dout_hi(s9_d3),  .idx_hi(s9_i3));
    compare_swap u_cs_s9_4_6   (.din_a(p4_d4),  .idx_a(p4_i4),  .din_b(p4_d6),  .idx_b(p4_i6),  .dir(1'b0), .dout_lo(s9_d4),  .idx_lo(s9_i4),  .dout_hi(s9_d6),  .idx_hi(s9_i6));
    compare_swap u_cs_s9_5_7   (.din_a(p4_d5),  .idx_a(p4_i5),  .din_b(p4_d7),  .idx_b(p4_i7),  .dir(1'b0), .dout_lo(s9_d5),  .idx_lo(s9_i5),  .dout_hi(s9_d7),  .idx_hi(s9_i7));
    compare_swap u_cs_s9_8_10  (.din_a(p4_d8),  .idx_a(p4_i8),  .din_b(p4_d10), .idx_b(p4_i10), .dir(1'b0), .dout_lo(s9_d8),  .idx_lo(s9_i8),  .dout_hi(s9_d10), .idx_hi(s9_i10));
    compare_swap u_cs_s9_9_11  (.din_a(p4_d9),  .idx_a(p4_i9),  .din_b(p4_d11), .idx_b(p4_i11), .dir(1'b0), .dout_lo(s9_d9),  .idx_lo(s9_i9),  .dout_hi(s9_d11), .idx_hi(s9_i11));
    compare_swap u_cs_s9_12_14 (.din_a(p4_d12), .idx_a(p4_i12), .din_b(p4_d14), .idx_b(p4_i14), .dir(1'b0), .dout_lo(s9_d12), .idx_lo(s9_i12), .dout_hi(s9_d14), .idx_hi(s9_i14));
    compare_swap u_cs_s9_13_15 (.din_a(p4_d13), .idx_a(p4_i13), .din_b(p4_d15), .idx_b(p4_i15), .dir(1'b0), .dout_lo(s9_d13), .idx_lo(s9_i13), .dout_hi(s9_d15), .idx_hi(s9_i15));

    // =========================================================
    // Step 10: 最终相邻比较，完成全排序
    // =========================================================
    wire [63:0] s10_d0,  s10_d1,  s10_d2,  s10_d3,  s10_d4,  s10_d5,  s10_d6,  s10_d7;
    wire [63:0] s10_d8,  s10_d9,  s10_d10, s10_d11, s10_d12, s10_d13, s10_d14, s10_d15;
    ...
    // =========================================================
    // Pipeline Register P5 / Output  (after step9+step10)
    // =========================================================

    // 组合逻辑：popcount of p4_bitmap
    always @(*) begin
        cnt = p4_bitmap[0]  + p4_bitmap[1]  + p4_bitmap[2]  + p4_bitmap[3]  +
              p4_bitmap[4]  + p4_bitmap[5]  + p4_bitmap[6]  + p4_bitmap[7]  +
              p4_bitmap[8]  + p4_bitmap[9]  + p4_bitmap[10] + p4_bitmap[11] +
    ...
    // 无复位：数据输出，仅 p4_vld=1 时锁存
    always @(posedge clk) begin
        if (p4_vld) begin
            o_dout0  <= s10_d0;  o_idx0  <= s10_i0;
            o_dout1  <= s10_d1;  o_idx1  <= s10_i1;
            o_dout2  <= s10_d2;  o_idx2  <= s10_i2;
            o_dout3  <= s10_d3;  o_idx3  <= s10_i3;
            o_dout4  <= s10_d4;  o_idx4  <= s10_i4;
            o_dout5  <= s10_d5;  o_idx5  <= s10_i5;
            o_dout6  <= s10_d6;  o_idx6  <= s10_i6;
            o_dout7  <= s10_d7;  o_idx7  <= s10_i7;
            o_dout8  <= s10_d8;  o_idx8  <= s10_i8;
            o_dout9  <= s10_d9;  o_idx9  <= s10_i9;
            o_dout10 <= s10_d10; o_idx10 <= s10_i10;
            o_dout11 <= s10_d11; o_idx11 <= s10_i11;
            o_dout12 <= s10_d12; o_idx12 <= s10_i12;
            o_dout13 <= s10_d13; o_idx13 <= s10_i13;
            o_dout14 <= s10_d14; o_idx14 <= s10_i14;
            o_dout15 <= s10_d15; o_idx15 <= s10_i15;
        end
    end
