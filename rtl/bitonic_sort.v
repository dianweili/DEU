...
//
// 优化：直接对 19-bit 压缩键 {exp[3:0], data[14:0]} 排序，
//       等价于对 64-bit square 排序（各 exp 值域不重叠且单调递增）。
//       排序完成后由顶层做 decomp_square 得到最终输出。
//       流水寄存器从 64-bit 降至 19-bit，比较器从 64-bit 降至 19-bit。
//
